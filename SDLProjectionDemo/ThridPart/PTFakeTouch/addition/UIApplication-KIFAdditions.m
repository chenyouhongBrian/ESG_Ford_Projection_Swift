...
@implementation UIApplication (Undocumented)
- (UIEvent *)sg_touchesEvent {
    NSString *selectorEncoded = @"X3RvdWNoZXNFdmVudA==";     // _touchesEvent
...
- (void)sg_pushRunLoopMode:(id)arg1 {
    NSString *selectorEncoded = @"cHVzaFJ1bkxvb3BNb2RlOg==";     // pushRunLoopMode:
    SEL selector = NSSelectorFromString([selectorEncoded stringBase64Decoded]);
...
- (void)sg_pushRunLoopMode:(id)arg1 requester:(id)requester {
    NSString *selectorEncoded = @"cHVzaFJ1bkxvb3BNb2RlOnJlcXVlc3Rlcjo=";     // pushRunLoopMode:requester:
    SEL selector = NSSelectorFromString([selectorEncoded stringBase64Decoded]);
...
- (void)sg_popRunLoopMode:(id)arg1 {
    NSString *selectorEncoded = @"cG9wUnVuTG9vcE1vZGU6";     // popRunLoopMode:
    SEL selector = NSSelectorFromString([selectorEncoded stringBase64Decoded]);
...
- (void)sg_popRunLoopMode:(id)arg1 requester:(id)requester {
    NSString *selectorEncoded = @"cG9wUnVuTG9vcE1vZGU6cmVxdWVzdGVyOg==";     // popRunLoopMode:requester:
    SEL selector = NSSelectorFromString([selectorEncoded stringBase64Decoded]);
...
+ (void)swizzleRunLoop;
{
    ...
    dispatch_once(&onceToken, ^{
        Swizzle(self, @selector(sg_pushRunLoopMode:), @selector(KIF_pushRunLoopMode:));
        Swizzle(self, @selector(sg_pushRunLoopMode:requester:), @selector(KIF_pushRunLoopMode:requester:));
        Swizzle(self, @selector(sg_popRunLoopMode:), @selector(KIF_popRunLoopMode:));
        Swizzle(self, @selector(sg_popRunLoopMode:requester:), @selector(KIF_popRunLoopMode:requester:));
    });
}
